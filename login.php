                    ...
                    <form name="login" action="" accept-charset="utf-8" method="post" enctype="multipart/form-data">
                        <fieldset>
							...
							<form name="btnlogin" action="login.php" accept-charset="utf-8" method="post" enctype="multipart/form-data">
                                                            <div class="" >
                            <button type="submit" name="btnLogin" class="btn btn-lg btn-success btn-block" ><i class="glyphicon glyphicon-log-in"></i> Login</button></div></form>
							<form name="btnSignup" action="signup.php" accept-charset="utf-8" method="post" enctype="multipart/form-data">
                                                            <div class="col-sm-6" >
						<!--	<button type="" name="btnsignup" class="btn btn-lg btn-success btn-block"> 
								<img src="files/photos/signup-icon.png" width="25" height="25" /></i> Sign up</button>-->
                                                            </div></form>
                        </fieldset>
                    </form>
                </div>
